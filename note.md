...
- [모델 생성 (마이그레이션 + 컨트롤러)](#---------------------)
- [컨트롤러만 생성](#--------)
- [blade.php 마스터 레이아웃 분리](#bladephp------------)
* [컨텐츠 파일 (위치: resources/views/\<anythingelse\>/)](#------------resources-views---anythingelse----)
* [레이아웃 파일 (위치: resources/views/layouts/)](#-------------resources-views-layouts--)
- [DB저장](#db--)
- [Response 간단하게 확인 (덤프)](#response-------------)
- [Validation](#validation)
- [Controller에서 모델 id 없이 Obj 이용하기](#controller------id----obj-----)
* [라우터 측](#-----)
* [컨트롤러 측](#------)
- [모델 생성시 주의사항](#-----------)
- [Tinker](#tinker)
- [1 : M Schema](#1---m-schema)
* [조회](#--)
+ [`Post.php` (1 Post : M Comment 상황일 때)](#-postphp---1-post---m-comment-------)
...
- [리다이렉트와 새로고침](#-----------)
* [현재 페이지로 리다이렉트 (새로고침)](#--------------------)
+ [controller측](#controller-)
* [다른 페이지로 리다이렉트](#-------------)
+ [controller측](#controller--1)
+ [router측](#router-)
...
* [post controller ( login_required 설정 )](#post-controller---login-required-----)
- [GET request에 특정 파라미터가 포함되어 있는지 확인](#get-request----------------------)
- [SQL 쿼리 사용](#sql------)
- [View composer 사용](#view-composer---)
* [AppServiceProvider.php](#appserviceproviderphp)
- [테스팅](#---)
* [테스트 케이스용 더미 모델 생성(or DB 시딩)](#------------------or-db----)
* [Unit/ExampleTest.php 수정](#unit-exampletestphp---)
- [Service provider](#service-provider)
- [Mail](#mail)
* [Dynamic Mail](#dynamic-mail)
* [markdown 메일 보내기](#markdown-------)
* [마크다운 메일 Customize](#--------customize)
- [Form request](#form-request)
- [Session Handling & Flash Messaging (세션 & 메세지)](#session-handling---flash-messaging-----------)
* [회원가입 환영 메세지 띄우기](#---------------)
- [N:M relation pivot table (다대다 관계)](#n-m-relation-pivot-table---------)
- [태그로 포스트 정렬하기](#------------)
* [사이드바에 태그 목록을 띄워보자](#-----------------)
- [Eventing 이벤트](#eventing----)
* [event:generate 안쓰고 직접 생성](#event-generate----------)
